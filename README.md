...
*   **Windows (PowerShell)**:
    ```powershell
    irm https://raw.githubusercontent.com/username/PyCk/main/bin/install_cli.ps1 | iex
    ```
*   **Unix / macOS (Shell)**:
    ```bash
    curl -fsSL https://raw.githubusercontent.com/username/PyCk/main/bin/install_cli.sh | bash
    ```
